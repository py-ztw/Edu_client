    ...
    <div class="course">
        ...
        <div class="main">
            ...
            <div class="course-list">
                ...
                <div class="course-item" v-for="course in course_list" @click="routers(course.id)">
                    ...
                    <div class="course-info">
                        <h3>
                            ...
                            <span><img src="/static/image/logo.png" alt="">{{course.students}}人已加入学习</span>
                        </h3>
...
<style scoped>
    ...
    .course-item .lesson-list li {
        ...
        background: url("/static/image/logo.png") no-repeat left 4px;
        margin-bottom: 15px;
    }
