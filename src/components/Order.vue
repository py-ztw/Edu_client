        ...
        <div class="cart-info">
            ...
            <div class="cart-item" v-for="(course,index) in course_list" :key="index">
                <el-row>
                    ...
                    <el-col :span="4" class="course-price" v-if="course.discount_name">{{course.discount_name}}：¥{{course.real_price}}</el-col>
                    <el-col :span="4" class="course-price" v-if="course.discount_name">原价：¥{{course.price}}</el-col>
                    <el-col :span="4" class="course-price" v-else>现价：¥{{course.price}}</el-col>
                </el-row>
            </div>
            <div class="calc">
                <el-row class="pay-row">
                    ...
                    <el-col :span="8">
                        <span class="alipay" >
                          <img src="../../static/image/alipay2.png" alt="" >
                        </span>
                        <span class="alipay wechat" ><img src="../../static/image/wechat_pay.jpg" alt=""></span>
                    </el-col>
    ...
    export default {
      ...
      methods:{
          pay_order(){
            ...
            this.$axios.post(`${this.$settings.HOST}order/option/`,{ pay_type:1,id:id},{
              headers:{
          ...
          get_course(){
            ...
            this.$axios.get(`${this.$settings.HOST}cart/order/`,{
              headers:{
                ...
                this.total = res.data.total_price.toFixed(2);
              console.log(this.course_list,this.total,"这里是order")
              }
            ).catch(err=>{
              this.$message.error(err.response)
            })
